...
lint-php: ## Lint PHP with PHP_CodeSniffer (PSR-12)
	...
	$(DC) exec -w /var/www $(PHP_CTR) /var/www/vendor/bin/phpcs -d memory_limit=512M --standard=/var/www/phpcs.xml /var/www/html/
...
lint-fix: ## Auto-fix all auto-fixable lint issues
	...
	$(DC) exec -w /var/www $(PHP_CTR) /var/www/vendor/bin/phpcbf -d memory_limit=512M --standard=/var/www/phpcs.xml /var/www/html/ || true
