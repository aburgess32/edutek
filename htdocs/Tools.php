...
$hostname = htmlspecialchars($_SERVER['HTTP_HOST'] ?? 'localhost:8080', ENT_QUOTES, 'UTF-8');
        ...
        <div class="resource-types__grid tools-grid">
            <?php foreach ($services as $key => $service): ?>
                ...
                <a
                    ...
                    <?php if (strtolower($label) !== 'khan interactive'): ?>
						target="_blank"
                ...
                >
                    ...
                    <span class="resource-card__content">
                        <span class="resource-card__title"><?php echo htmlspecialchars($label, ENT_QUOTES, 'UTF-8'); ?></span>
                        <span class="resource-card__description">Open this offline learning tool.</span>
                    </span>
