      ...
      root.innerHTML =
        '<div class="card" style="text-align:center;padding:40px">' +
          ...
          '<div style="font-size:14px;color:var(--teacher-muted);margin-bottom:16px">' +
            'The API returned an error. Please check your database connection and try again.' +
          '</div>' +
          '<button class="action-btn" style="max-width:200px;margin:0 auto" onclick="location.reload()">Retry</button>' +
        '</div>';
    });
  }
